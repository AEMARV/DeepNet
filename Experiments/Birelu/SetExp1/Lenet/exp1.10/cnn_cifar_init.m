...
% Block 3 
net.layers{end+1} = struct('type', 'conv', ... 
                           'weights', {{0.05*randn(5,5,k*32,k*64, 'single'), zeros(1,k*64,'single')}}, ... 
                           'learningRate', lr, ... 
                           'stride', 1, ... 
                           'pad', 2) ; 
net.layers{end+1} = struct('type', 'birelu') ;
...
net.layers{end+1} = struct('type', 'birelu') ; 
block = 64;
 net = addAutoEnc(net,1,block,lr,k);
% Block 5 
net.layers{end+1} = struct('type', 'conv', ... 
...
net.meta.trainOpts.learningRate = [0.05*ones(1,30) 0.005*ones(1,10) 0.0005*ones(1,20)] ; 
