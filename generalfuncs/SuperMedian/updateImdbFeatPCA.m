function [imdb ] = updateImdbFeatPCA( imdb,Norm ,pcaMethod)
%UPDATEIMDBFEATPCA Summary of this function goes here
%   Detailed explanation goes here
% pca Method : purel1,maxmed,cor,pca
...
for i =  1 : ceil(imageNum/batchsize)
    ...
    [newFeat,currLocs] = extractMedPCA( batch,2,true,Norm,0,pcaMethod);
    [currLocs,~] = extractMedPCA(currLocs,-1,false,Norm,0,pcaMethod);
