...
if isload && loadconv
    ...
    convInit = 20*eyeconv(5,5,chk*k*32,k*32, 'single');
    convbias = zeros(1,k*32,'single');
end
...
if isload && loadconv
    ...
    convInit = 20*eyeconv(5,5,chk*k*32,k*64, 'single');
...
if isload && loadconv
    ...
    convInit = 20*eyeconv(4,4,chk*k*64,k*64, 'single');
    convbias = zeros(1,k*64,'single');
end
net.layers{end+1} = struct('type', 'conv', ...
    'weights', {{0.05*convInit/k,convbias}}, ...
...
if isload && loadconv
    ...
    convInit = 20*eyeconv(1,1,chk*k*64,10, 'single');
